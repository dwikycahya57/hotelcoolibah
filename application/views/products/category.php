            ...
            <?php foreach ($products as $product): ?>
                <li class="span2">
                    <div class="thumbnail">
                        ...
                        <?php endif; ?>
                        <div class="caption">
                            <a href="<?php echo base_url() ?>index.php/products/detail/<?php echo $product['permalink'] ?>"> <h5><?php echo $product['name']; ?></h5></a>Price:Rp.<?php echo number_format($product['net_price']); ?> 
                        </div>
                    </div>
                </li>
            <?php endforeach; ?>
